...
def main():
    ...
    inpath = "/Users/dannydiamond/NUIG/Polifonia/CRE_clean/testing/feat_seq_data/accent"
    feature = "pitch_class"
    n_vals = [5, 6, 7]
    ...
    ngram_corpus.save_results(outpath="/Users/dannydiamond/NUIG/Polifonia/CRE_clean/testing", corpus_name='test')
    return ngram_corpus
