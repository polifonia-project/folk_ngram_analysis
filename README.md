...
* 3- Extraction of n-gram patterns for selected musical features(s). So far, the emphasis has been on n-grams for 3 <= n <= 12 on five feature sequences, including melodic contour, interval, pitch, pitch-class interval, and pitch class. 
